...
export default function Register() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    fetch(`${apiBaseUrl}/v1/auth/register`, {
      method: "POST",
      ...
      .catch((error) => {
        ...
        toast.error(error.message || "Failed to register. Please try again.", { id: loadingToast });
      })
      .finally(() => {
        setLoading(false);
      });
    ...
    <div className="flex items-center justify-center min-h-screen bg-black p-6">
      <div className="w-full max-w-md bg-white text-black rounded-2xl shadow-2xl p-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600 mt-2">Join the secure wallet platform for teams</p>
        </div>
